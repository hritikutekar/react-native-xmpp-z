...
public class RNXMPPCommunicationBridge implements XmppServiceListener {
    ...
    public static final String RNXMPP_RECEIPT =     "RNXMPPReceipt";
    ...
    @Override
    public void onReceipt(String fromJid, String receiptId) {
        WritableMap params = Arguments.createMap();
        params.putString("fromJid", fromJid);
        params.putString("receiptId", receiptId);
        sendEvent(reactContext, RNXMPP_RECEIPT, params);
    }
